...
You can add clarifying details in the chat thread with any business that has quoted your job — before or after you accept — but you can't edit the original post. If the post needs major changes, cancel it and re-post.
...
SwingBy doesn't have a built-in counter-offer feature — the quote is a single price. But you can message a business as soon as it quotes your job, before you accept, so you can discuss scope and price on that thread. If price is your main concern, compare quoted prices before deciding.
