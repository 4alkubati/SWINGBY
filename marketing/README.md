...
| File | Purpose |
|---|---|
| [01-monetization-strategy.md](01-monetization-strategy.md) | How SwingBy makes money — primary, secondary, future revenue streams |
...
1. **Before any marketing decision** — read the relevant file. Don't reinvent.
2. **After any marketing experiment** — update the relevant file with what worked and what didn't.
3. **When asked "how do we make money?"** — open `01-monetization-strategy.md`. That's the answer.

---

## Canonical identity

**The domain is `swingbyy.com`** (double-y). We do not own `swingby.com`, `swingby.ca`, or `swingby.app` — all three are registered to third parties. `swingbyapp.com` / `.ca` are unregistered and should be bought defensively. Every public address is `@swingbyy.com`; `amr@swingbyy.com` is the founder login and is never published. Full detail and evidence in [13-accounts-and-identity.md](13-accounts-and-identity.md).
...
- Backend: ✅ Built
- Web pre-launch site: 🟡 Built, untested end-to-end
- Mobile app: 🟡 Built, untested end-to-end
- Marketing plan: ✅ Drafted in this folder
