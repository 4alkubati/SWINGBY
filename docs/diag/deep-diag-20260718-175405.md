...
Generated: 2026-07-18 17:57 MDT · run `bash tools/deep_diag.sh`
...
| Flow | Result | Cause |
|---|---|---|
| PYTEST | PASS | 52 passed, 3 skipped, 3 warnings in 1.86s |
| BABEL_SYNTAX | SKIPPED | node not available on this box |
| FLOW_GRAPH | PASS | [flow_graph] broken edges: 0  global orphans: 0  per-nav orphans: 0  broken api: 0 |
| LOCAL_BOOT | FAIL | container never answered /healthz within 60s — check pip install / uvicorn boot errors in /home/l3thal/agents/projects/swingby/docs/diag/logs/20260718-175405/local_boot.log |
...
Full stage logs: `docs/diag/logs/20260718-175405/`

- PYTEST: see /home/l3thal/agents/projects/swingby/docs/diag/logs/20260718-175405
- BABEL_SYNTAX: see /home/l3thal/agents/projects/swingby/docs/diag/logs/20260718-175405
- FLOW_GRAPH: see /home/l3thal/agents/projects/swingby/docs/diag/logs/20260718-175405
- LOCAL_BOOT: see /home/l3thal/agents/projects/swingby/docs/diag/logs/20260718-175405
- E2E_SMOKE_LOCAL: see /home/l3thal/agents/projects/swingby/docs/diag/logs/20260718-175405
