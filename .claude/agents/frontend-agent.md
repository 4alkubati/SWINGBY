...
1. `/home/l3thal/brain/projects/swingby/BOH/frontend.md` — your full role definition
2. `/home/l3thal/brain/projects/swingby/claude/PRODUCT-VISION.md` — COMMON section only (web has no dedicated slice; the design-agent slice covers look/feel)
