...
1. `AGENTS/BOH/frontend.md` — your full role definition
2. `AGENTS/claude/PRODUCT-VISION.md` — COMMON section only (web has no dedicated slice; the design-agent slice covers look/feel)
3. `AGENTS/claude/config/PATH-INDEX.md` — where files live; never grep for paths
