...
1. `AGENTS/BOH/backend.md` — your full role definition (standards, escalation, DONE format)
2. `AGENTS/claude/PRODUCT-VISION.md` — COMMON section + ROLE: backend-agent slice ONLY
