...
1. `/home/l3thal/brain/projects/swingby/BOH/backend.md` — your full role definition (standards, escalation, DONE format)
2. `/home/l3thal/brain/projects/swingby/claude/PRODUCT-VISION.md` — COMMON section + ROLE: backend-agent slice ONLY
