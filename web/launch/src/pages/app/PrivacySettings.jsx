  ...
  return (
    <div style={{ maxWidth: '560px' }}>
      ...
      <div style={{ marginTop: 'var(--space-xl)', display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
        <p style={{ fontSize: '14px', color: 'var(--color-text-secondary)' }}>To request deletion of your data or exercise your PIPEDA rights, email <a href="mailto:privacy@swingby.ca" style={{ color: 'var(--color-accent-text)' }}>privacy@swingby.ca</a>.</p>
